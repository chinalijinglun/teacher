	...
	<div class="finish-course">
		<div class="top-title">
			<div class="first-line">
				...
				<div>
					<span class="study-time">Time for class（Current time zone: {{$TIME_ZONE[timezone] || timezone}}）：{{course.course_times}}</span>
				</div>
		...
		<div class="table">
			...
			<div class="table-list" v-for="item in tableData" :key="item.id">
				<div class="list-tit">
					<span>Time for class（Current time zone: {{$TIME_ZONE[timezone] || timezone}}）：{{item.start | courseScheduleTime(item.end)}}</span>
				</div>
