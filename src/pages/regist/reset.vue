	...
	<div class="regist">
		<div class="main-contain">
			...
			<el-form label-width="240px" ref="registForm" :rules="rules" :model="form" class="regist-form" :validate-on-rule-change="false">
				...
				<el-form-item>
					<div class="form-input">
						<el-button class="regist-now" @click="regist" type="primary" style="width: 100%">Reset Now</el-button>
					</div>
				</el-form-item>
			</el-form>
		</div>
	...
	methods: {
        ...
        const {
          ...
          password
				...
				return authResetpasswordPost({
          // code,
          username,
          verify_code,
          password
        }).then(resp=> {
					this.$message.success('Reset password successful, Please login again!');
